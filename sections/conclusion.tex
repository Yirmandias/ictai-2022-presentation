...
\begin{frame}[c]{Conclusion \& Perspectives}
    ...
    \begin{itemize}
        \pause
        \item Extending the automated analysis of operational models \footnotemark[1] \footnotetext[1]{Guidance of a Refinement-based Acting Engine with a Hierarchical Temporal Planner\cite{turiGuidanceRefinementbasedActing2022}} to concurrency and resource primitives.
        \pause
