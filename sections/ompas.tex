...
\begin{frame}[fragile]{Defining $A_\Delta$ with Scheme OMPAS (SOMPAS)}
...
\begin{frame}[c,fragile]{Example: the gripper-door problem}
    \begin{columns}[T]
...
\begin{frame}[fragile]{Gripper-door: definition of action models in PDDL fashion}
    \small
    \begin{itemize}
