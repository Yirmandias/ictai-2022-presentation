...
\begin{frame}{Summary of the proposal}
    \begin{itemize}
        \item RAE with task refinement guided by planning;
        \item Extraction of the planning domain (chronicle) from the acting domain and \textbf{platform model}
    \end{itemize}
\end{frame}
    ...
    \begin{columns}[c]
        ...
        \begin{column}<1->{0.7\textwidth}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    \item at(\{ball, robot\}) $\rightarrow$ loc
